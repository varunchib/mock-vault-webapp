...
export const postGuides: Record<string, PostGuideData> = {
  ...
  // ─── JKSSB Constable (Executive / Armed / IRP / SDRF) ──────────────────────
  // Source: JKSSB Notice No. JKSSB/COE0EXAM(UT)/47/2023-03 (7202110) dated
  // 03.10.2024, Annexure A. One syllabus governs Constable (Armed/IRP),
  // Constable (SDRF) and Constable (Executive Police) — hence one guide.
  'jkssb-constable': {
    title: 'JKSSB Constable Syllabus & Exam Pattern 2026 (Executive/Armed/IRP/SDRF)',
    shortName: 'JKSSB Constable',
    tagline: 'One syllabus covers Constable (Executive Police), Constable (Armed/IRP) and Constable (SDRF) — 100 questions, 100 marks, 2 hours. Written exams scheduled for 13 and 20 December 2026.',
    lastUpdated: '2026-08-03',
    patternNotification: 'Syllabus notified by JKSSB vide Notice No. JKSSB/COE0EXAM(UT)/47/2023-03 (7202110) dated 03.10.2024, Annexure A, issued against Advertisement Notification No. 01 of 2024 dated 16.07.2024. Written examinations per the JKSSB exam-date annexure: Constable (Executive) 13 December 2026 under Notification 12 of 2025; Constable (Armed/IRP/SDRF) 20 December 2026 under Notification 14 of 2025.',
    quickFacts: [
      { label: 'Exam Date (Executive)', value: '13 December 2026' },
      { label: 'Exam Date (Armed/IRP/SDRF)', value: '20 December 2026' },
      { label: 'Questions', value: '100 MCQs' },
      { label: 'Total Marks', value: '100 (1 mark each)' },
      { label: 'Duration', value: '2 hours' },
      { label: 'Neg. Marking', value: '0.25 per wrong answer' },
    ],
    examSlug: 'jkssb-constable',
    papers: [],
    conductingBody: 'Jammu & Kashmir Services Selection Board (JKSSB)',
    officialWebsite: 'https://jkssb.nic.in',
    examLevel: 'UT Level (J&K Police, Home Department)',
    examMode: 'Offline / OMR — objective type',
    about: [
      'The JKSSB Constable examination recruits for three posts in the J&K Police under the Home Department — Constable (Executive Police), Constable (Armed/IRP) and Constable (SDRF). JKSSB notified a single common syllabus for all three in Annexure A to its notice of 03.10.2024, so a candidate preparing for one is preparing for all three.',
      'The written test is 100 objective questions for 100 marks in 2 hours. General Knowledge is the largest block at 35 marks once the India and J&K sections are combined, followed by Numerical & Reasoning Ability and General English at 25 marks each, and Basic Concepts of Computers at 15.',
      'Written marks decide who proceeds to the Physical Standard Test and Physical Endurance Test. Candidates are typically shortlisted for PST at around six times the vacancies in each category, so the written paper is the real filter.',
    ],
    syllabus: [
      { subject: 'General English (25 marks)', topics: [
          'General English - articles, clauses, pronouns, homonyms/homophones, tenses, punctuation',
          'General English - synonyms and antonyms, analogies, idioms and phrases, prepositions',
      ] },
      { subject: 'General Knowledge & Current Affairs — India (25 marks)', topics: [
          'GK & Current Affairs - important dates in Indian history and the freedom struggle',
          'GK & Current Affairs - firsts in India and the world; popular names of personalities',
          'GK & Current Affairs - books and authors, famous places, languages, capitals and currencies',
          'GK & Current Affairs - United Nations (veto powers, principal organs), SAARC, ASEAN',
          'GK & Current Affairs - everyday science; world and national awards in science, literature and sports',
          'GK & Current Affairs - climate and crops in India; important rivers and lakes',
          'GK & Current Affairs - Constitution of India (formation, fundamental rights, directive principles)',
          'GK & Current Affairs - democratic institutions, forms of government, political and physical divisions',
          'GK & Current Affairs - agriculture and industrialisation in economic development',
          'GK & Current Affairs - centrally sponsored schemes, Indian foreign trade',
      ] },
      { subject: 'General Knowledge — special reference to J&K (10 marks)', topics: [
          'J&K - abbreviations, important dates, personalities and their contributions',
          'J&K - weather, climate, crops, means of transport',
          'J&K - important power projects and their impact on the economy',
          'J&K - rivers and lakes; important tourist destinations',
          'J&K - history and historical places of significance',
          'J&K - RTI Act; Indus Water Treaty and its economic impact',
          'J&K - current events of local, national and international importance',
      ] },
      { subject: 'Numerical & Reasoning Ability (25 marks)', topics: [
          'Basic arithmetic - number system, percentage, average, profit & loss',
          'Basic arithmetic - ratio & proportion, speed/distance/time, simplification',
          'Basic arithmetic - decimal fractions, simple and compound interest',
          'Basic algebra, mensuration, trigonometry, mathematical reasoning',
          'Reasoning - number series, letter series, coding-decoding, direction sense',
          'Reasoning - blood relations, statements and conclusions, logical and mental reasoning',
          'Reasoning - sequential output tracing, assertions and reasons, arithmetical operations',
      ] },
      { subject: 'Basic Concepts of Computers (15 marks)', topics: [
          'Computer terminology; hardware and software',
          'Input and output devices; storage and operating systems',
          'MS Word and MS Excel',
          'Safety and security; computer virus concepts',
          'E-mail, internet usage and search engines',
      ] },
    ],
    examPattern: [
      { section: 'General English', questions: 25, marks: 25 },
      { section: 'General Knowledge & Current Affairs (India)', questions: 25, marks: 25 },
      { section: 'General Knowledge (J&K)', questions: 10, marks: 10 },
      { section: 'Numerical & Reasoning Ability', questions: 25, marks: 25 },
      { section: 'Basic Concepts of Computers', questions: 15, marks: 15 },
      { section: 'Total', questions: 100, marks: 100, isTotal: true },
    ],
    examPatternNote: 'Objective type, 100 marks, 2 hours, 1 mark per question, 0.25 negative marking. Section marks are as notified in Annexure A dated 03.10.2024. Combined General Knowledge (India 25 + J&K 10) is 35 marks — the single largest block on the paper.',
    eligibility: {
      age: '18–28 years for general category (as per Advertisement Notification 12/14 of 2025); category relaxations apply and in-service police personnel are relaxed further. Confirm the exact window against the official notification.',
      education: 'Matriculation (10th pass) from a recognised board, as per the advertisement. Confirm against the official notification.',
      domicile: 'Domicile of the Union Territory of Jammu & Kashmir; a valid domicile certificate is required on or before the last date of application.',
    },
    selectionProcess: [
      'Written examination — 100 objective questions, 100 marks, 2 hours, 0.25 negative marking.',
      'Physical Standard Test (PST) — candidates shortlisted on written marks, typically six times the vacancies in each category.',
      'Physical Endurance Test (PET) — both PST and PET are mandatory and qualifying.',
      'Document verification and medical examination.',
    ],
    salary: [
      { post: 'Constable (Executive / Armed / IRP / SDRF)', payScale: 'Rs. 19,900 – 63,200', level: 'Pay Level 2' },
    ],
    preparationTips: [
      'Combined General Knowledge is 35 of 100 marks. J&K GK is finite, repeats heavily and is the cheapest section to master — start there rather than with English or maths.',
      'Basic Computers is 15 marks of purely factual, learnable content. It is the highest marks-per-hour section on the paper and the one most candidates neglect.',
      'Negative marking is 0.25, so blind guessing costs you. Answer what you know, eliminate to two options before risking a guess.',
      'Begin PET conditioning alongside the written preparation, not after the result. Running and push-up capacity take months to build, and the gap between written and PST is short.',
      'Numerical & Reasoning at 25 marks rewards drilling a single method per question type rather than collecting several approaches.',
    ],
    analysis: {
      intro: 'Two sections carry 60 of the 100 marks: General Knowledge (India + J&K combined, 35) and Numerical & Reasoning Ability (25).',
      difficulty: 'A single-stage objective paper with 0.25 negative marking and 2 hours for 100 questions — time pressure is mild, so accuracy rather than speed separates candidates. The physical stages, not the written paper, are where most attrition happens.',
    },
  },

  // ─── JKSSB Constable (Telecommunication) ───────────────────────────────────
  // Source: same JKSSB notice dated 03.10.2024, Annexure B.
  'jkssb-constable-telecom': {
    title: 'JKSSB Constable Telecommunication Syllabus & Exam Pattern 2026',
    shortName: 'JKSSB Constable Telecom',
    tagline: '60 marks of aptitude plus 40 marks of technical questions — radio communication, television transmission, antennas, mobile communication and electricity. Written exam scheduled for 27 December 2026.',
    lastUpdated: '2026-08-03',
    patternNotification: 'Syllabus notified by JKSSB vide Notice No. JKSSB/COE0EXAM(UT)/47/2023-03 (7202110) dated 03.10.2024, Annexure B, issued against Advertisement Notification No. 01 of 2024 dated 16.07.2024. Written examination scheduled for 27 December 2026 under Notification 15 of 2025 (Item No. 325) per the JKSSB exam-date annexure.',
    quickFacts: [
      { label: 'Exam Date', value: '27 December 2026' },
      { label: 'Questions', value: '100 MCQs' },
      { label: 'Total Marks', value: '100 (Aptitude 60 + Technical 40)' },
      { label: 'Duration', value: '2 hours' },
      { label: 'Neg. Marking', value: '0.25 per wrong answer' },
    ],
    examSlug: 'jkssb-constable-telecom',
    papers: [],
    conductingBody: 'Jammu & Kashmir Services Selection Board (JKSSB)',
    officialWebsite: 'https://jkssb.nic.in',
    examLevel: 'UT Level (J&K Police, Home Department)',
    examMode: 'Offline / OMR — objective type',
    about: [
      'Constable (Telecommunication) is the technical stream of the J&K Police constabulary, recruited by JKSSB under the Home Department. Unlike the Executive and Armed posts, its paper is split: 60 marks of general aptitude and 40 marks of technical questions notified separately as Annexure B.',
      'The aptitude half mirrors the general Constable syllabus but at reduced weight — English 15, GK India 15, GK J&K 5, Numerical & Reasoning 15 and Computers 10. The technical half is where the post is actually won or lost.',
      'The technical syllabus covers radio communication and propagation, television transmission, antennas and transmission lines, modulation and demodulation, mobile communication including GSM and CDMA, communication equipment, electrical and electronic gadgets, e-governance, and basic electricity including wiring, machines and earthing.',
    ],
    syllabus: [
      { subject: 'General English (15 marks)', topics: [
          'General English - articles, clauses, pronouns, homonyms/homophones, tenses, punctuation',
          'General English - synonyms and antonyms, analogies, idioms and phrases, prepositions',
      ] },
      { subject: 'General Knowledge & Current Affairs — India (15 marks)', topics: [
          'GK & Current Affairs - important dates in Indian history and the freedom struggle',
          'GK & Current Affairs - firsts in India and the world; popular names of personalities',
          'GK & Current Affairs - books and authors, famous places, languages, capitals and currencies',
          'GK & Current Affairs - United Nations (veto powers, principal organs), SAARC, ASEAN',
      ...
      { subject: 'General Knowledge — special reference to J&K (5 marks)', topics: [
          'J&K - abbreviations, important dates, personalities and their contributions',
          'J&K - weather, climate, crops, means of transport',
          'J&K - important power projects and their impact on the economy',
          'J&K - rivers and lakes; important tourist destinations',
      ...
      { subject: 'Numerical & Reasoning Ability (15 marks)', topics: [
          'Basic arithmetic - number system, percentage, average, profit & loss',
          'Basic arithmetic - ratio & proportion, speed/distance/time, simplification',
          'Basic arithmetic - decimal fractions, simple and compound interest',
          'Basic algebra, mensuration, trigonometry, mathematical reasoning',
      ...
      { subject: 'Basic Concepts of Computers (10 marks)', topics: [
          'Computer terminology; hardware and software',
          'Input and output devices; storage and operating systems',
          'MS Word and MS Excel',
          'Safety and security; computer virus concepts',
      ...
      { subject: 'Technical — Radio & Television (part of 40 marks)', topics: [
          'Modulation - amplitude and frequency modulation, modulation index, carrier and modulated signal',
          'AM and FM modulators, demodulation, bandwidth, AM and FM applications',
          'Superheterodyne radio receiver; FM receiver',
          'Radio wave propagation - ground wave, sky wave, space wave; AF, IF, RF',
          'Television transmitters; antennas and types (dipole), transmission lines, feeders, coaxial cables',
          'Persistence of vision, picture transmission, scanning in the picture tube',
          'Progressive and interlaced scanning, composite video signal, video bandwidth, SSB, VHF and UHF ranges',
      ] },
      { subject: 'Technical — Electronics & Telecommunication (part of 40 marks)', topics: [
          'Need for modulation; AM, FM, PM, SSB-SC and DSB-SC; AM and FM transmitter block diagrams',
          'FM generation and detection; comparison of AM, FM and PM',
          'Antenna fundamentals, parameters, types and applications',
          'Digital modulation and demodulation - sampling, quantization, encoding',
          'Multiplexing and de-multiplexing; PAM, PPM and PWM signals',
          'Mobile communication - cell site, hand-off, frequency reuse, cell phone block diagram, GSM and CDMA',
          'Communication equipment - AM/FM radio, television, optical fibre equipment',
          'Electrical and electronic gadgets - UPS, inverter, stabiliser, SMPS',
          'e-Governance - objectives, origins in India, work plan and infrastructure, DBMS, anti-virus',
      ] },
      { subject: 'Technical — Electricity (part of 40 marks)', topics: [
          'Electrical units; effects of electric current; conductors and insulators',
          'Types of solder and flux; AC circuits',
          'Magnetic terms and units; magnetic materials; properties of magnets; laws of electromagnetism',
          'Wiring and IE rules; switches, fuses, MCB, ELCB, MCCB, RCCB, relays',
          'Earthing - megger and earth tester',
          'DC generator - principle, parts, types, EMF equation, voltage build-up',
          'Three-phase induction motor - principle, parts, slip, speed, rotor frequency, torque, copper loss, applications',
      ] },
    ],
    examPattern: [
      { section: 'General English', questions: 15, marks: 15 },
      { section: 'General Knowledge & Current Affairs (India)', questions: 15, marks: 15 },
      { section: 'General Knowledge (J&K)', questions: 5, marks: 5 },
      { section: 'Numerical & Reasoning Ability', questions: 15, marks: 15 },
      { section: 'Basic Concepts of Computers', questions: 10, marks: 10, note: 'Aptitude subtotal: 60 marks' },
      { section: 'Technical Questions', questions: 40, marks: 40 },
      { section: 'Total', questions: 100, marks: 100, isTotal: true },
    ],
    examPatternNote: 'Objective type, 100 marks, 2 hours. Aptitude carries 60 marks and technical 40, as notified in Annexure B dated 03.10.2024. The technical block is the differentiator — aptitude marks are broadly achievable by every candidate, so the 40 technical marks decide the merit list.',
    eligibility: {
      age: '18–28 years for general category as per the advertisement; category relaxations apply. Confirm the exact window against the official notification.',
      education: 'As specified for the Telecommunication stream in Advertisement Notification 15 of 2025 — a technical qualification is required beyond the matriculation baseline that applies to the Executive post. Confirm against the official notification.',
      domicile: 'Domicile of the Union Territory of Jammu & Kashmir; a valid domicile certificate is required on or before the last date of application.',
    },
    selectionProcess: [
      'Written examination — 100 objective questions, 100 marks (60 aptitude + 40 technical), 2 hours.',
      'Physical Standard Test (PST) — shortlisting on written marks.',
      'Physical Endurance Test (PET) — mandatory and qualifying.',
      'Document verification and medical examination.',
    ],
    salary: [
      { post: 'Constable (Telecommunication)', payScale: 'Rs. 19,900 – 63,200', level: 'Pay Level 2' },
    ],
    preparationTips: [
      'The 40 technical marks decide this paper. Every candidate can score reasonably on the 60 aptitude marks, so the merit list is built on the technical block — give it the majority of your study time.',
      'Within technical, modulation and radio propagation recur most heavily and are conceptually compact. Master those before moving to television transmission.',
      'Electricity topics (wiring, protective devices, DC generator, three-phase induction motor) are factual and highly scoreable — do not leave them until last.',
      'J&K GK is only 5 marks here versus 10 on the Executive paper. Do not over-invest in it at the cost of technical revision.',
      'Basic Computers at 10 marks overlaps with the e-Governance and DBMS items in the technical syllabus — study them together and you cover both.',
    ],
    analysis: {
      intro: 'Aptitude is 60 marks and technical 40, but the technical block carries almost all the discriminating power because aptitude scores cluster.',
      difficulty: 'Moderate on aptitude, and dependent on your engineering background for technical. Candidates from electronics, telecommunication or electrical streams have a substantial advantage on the 40 technical marks.',
    },
  },
