...
export function PyqPaperPage() {
  ...
  const title = paper
    ? `${paper.title} — Questions & Answers | PYQVault`
  ...
  if (loading) {
    return (
      <section className="public-page">
        <div className="public-shell"><HaloLoader label="Loading paper" /></div>
      </section>
    )
  }
            ...
            {firstQuestion && (
              <button
                ...
                onClick={() => {
                  ...
                  navigate(`/question/${firstQuestion.slug}`)
                }}
              >
            ...
            return (
              <article className="pyq-question-card" key={q.slug}>
                <div className="pyq-q-header">
                  ...
                  <span className="pyq-q-subject">{q.subject}</span>
                </div>
