  ...
  return (
    <Reveal as="section" className="cta-section">
      ...
      <div className="cta-btns">
        <button className="cta-primary" type="button" onClick={() => navigate('/exams')}>Search Your Exam - It&apos;s Free</button>
        <button className="cta-secondary" type="button" onClick={() => navigate('/exams')}>Browse all 240+ exams →</button>
      </div>
    </Reveal>
  )
}
