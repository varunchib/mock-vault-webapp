...
export function ExamAnalyticsPage() {
  ...
  if (!examSlug) return <Redirect to="/analytics" replace />
  if (!results.length || !summary) return <Redirect to={`/exam/${examSlug}`} replace />
  ...
  return (
    <section className="ea2-page workspace-page">
      ...
      <header className="ea2-header">
        <Link href="/analytics" className="ea2-back">
