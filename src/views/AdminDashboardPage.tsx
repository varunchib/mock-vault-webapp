  ...
  return (
    <section className={`admin-workspace${darkMode ? ' admin-dark' : ''}`}>
      ...
      <aside className="admin-rail">
        <Link className="vault-logo" href="/admin">
          <span>
        ...
        <nav className="admin-rail-nav">
          ...
          <Link className="admin-nav-btn" href="/exams"><Home size={17} /> App home</Link>
        ...
        <button className="admin-rail-logout" type="button" onClick={() => void logout().then(() => router.push('/'))}>
            ...
            <div className="admin-overview-grid">
              <div className="admin-tool-panel">
                ...
                <div className="admin-quick-actions">
                  ...
                  <Link className="admin-quick-btn" href="/exams" target="_blank" rel="noopener noreferrer">
                  ...
                  >
                    ...
                    <div className="admin-row-actions" onClick={(e) => e.stopPropagation()}>
                      {pendingDeleteMock === mock.slug ? (
                        ...
                        <>
                          <Link className="admin-row-action" href={`/mock-test/${mock.examSlug}`} target="_blank"><ExternalLink size={13} /></Link>
              ...
              <div className="admin-tool-panel admin-mock-preview">
                <div className="admin-panel-title">
                  ...
                  <div className="admin-row-actions">
                    ...
                    <Link className="admin-row-action" href={`/mock-test/${selectedMock.examSlug}`} target="_blank">
                    ...
                    <div className="admin-row-actions">
                      {pendingDeletePaper === paper.slug ? (
                        ...
                        <>
                          ...
                          <Link className="admin-row-action" href={`/pyq/${paper.slug}`} target="_blank"><ExternalLink size={13} /></Link>
