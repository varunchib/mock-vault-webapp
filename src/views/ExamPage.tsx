  ...
  const hub = (
    <div className="ep-page">
      ...
      <nav className="ep-breadcrumb" aria-label="Breadcrumb">
        <Link href={homeHref}>{isAuthenticated ? 'Exams' : 'Home'}</Link>
                  ...
                  <div className="ep-paper-grid">
                    {yearPapers.map((paper) => (
                      <div className="ep-paper-card" key={paper.slug}>
                        <Link className="ep-paper-card-inner" href={`/pyq/${paper.slug}`}>
          ...
          {(() => {
            ...
            return (
              <div className="ep-guides-strip">
                ...
                {guides.map(([slug, g]) => (
                  <Link key={slug} className="ep-guide-chip" href={`/guide/${slug}`}>
              ...
              {filteredMocks.map((mock) => (
                <div className={`ep-mock-card ep-mock-${mock.difficulty.toLowerCase()}`} key={mock.slug}>
                  ...
                  <div className="ep-mock-footer">
                    {isAuthenticated ? (
                      <Link className="ep-start-btn" href={`/mock-attempt/${mock.slug}`}>
                        Start Mock
                      </Link>
                    ) : (
                    ...
                    <Link className="ep-preview-btn" href={`/mock-test/${mock.slug}`}>
                      Preview
                    </Link>
                  </div>
                </div>
